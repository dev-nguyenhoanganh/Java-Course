...
import com.luvina.btvn.gui.panel.MainPanel;
...
public class GUI extends JFrame implements ICommon, IChangeColor {
	...
	public static final int HEIGHT = 380 + 39;

	public static final Font fontHeader = new Font("Calibri", Font.BOLD, 26);
...
//		setVisible(true);
	...
	public void changeColor(Color newColor) {
		this.mainPanel.changeColor(newColor);
	}
